...
public class controlDriveTrain extends Command {
	...
	private TalonSRX motorLeftThree;

	private int currentOffCount;
	private int passnum = 0;
	private double minCurrentScaler= 1;
	
    public controlDriveTrain(TalonSRX l1, TalonSRX l2, TalonSRX l3, TalonSRX r1, TalonSRX r2, TalonSRX r3, int maxCurrent) {
    ...
    protected void initialize() {
      ...
      /*  this.motorRightOne.configOpenloopRamp(0.3, 0);
    	...
    	this.motorRightOne.setInverted(true);
    	this.motorRightTwo.setInverted(true);
    	this.motorRightThree.setInverted(true);
    	this.motorLeftOne.setInverted(true);
