...
public class motionMagicDriveForward extends Command {
    ...
    fGainLeft = 0.1189;// + 0.0127f;
    fGainRight = fGainLeft + 0.02;
    pGainLeft = 0;
    pGainRight= 0;
   ...
   // Robot.startedCommand= true;
    ...
    RobotMap.motorLeftThree.configSelectedFeedbackSensor(com.ctre.phoenix.motorcontrol.FeedbackDevice.CTRE_MagEncoder_Relative, 0, 0);
  ...
  //  RobotMap.motorRightTwo.setSensorPhase(true);
	...
	RobotMap.motorLeftThree.setInverted(true);
    ...
    RobotMap.motorRightThree.getSensorCollection().setQuadraturePosition(0, 0);
    RobotMap.motorLeftTwo.getSensorCollection().setQuadraturePosition(0, 0);
    RobotMap.motorLeftThree.getSensorCollection().setQuadraturePosition(0, 0);
    
    RobotMap.motorLeftThree.set(com.ctre.phoenix.motorcontrol.ControlMode.MotionMagic,this.motionMagicEndPoint);		
	RobotMap.motorLeftTwo.set(com.ctre.phoenix.motorcontrol.ControlMode.Follower, RobotMap.leftThreeTalonID);
	RobotMap.motorLeftOne.set(com.ctre.phoenix.motorcontrol.ControlMode.Follower, RobotMap.leftThreeTalonID);
	...
	RobotMap.motorRightThree.set(com.ctre.phoenix.motorcontrol.ControlMode.Follower, RobotMap.rightTwoTalonID);	
	
	
	RobotMap.motorLeftThree.configPeakOutputForward(0.9, 0);
	RobotMap.motorLeftThree.configNominalOutputForward(0, 0);
	RobotMap.motorRightTwo.configPeakOutputForward(0.9, 0);
	RobotMap.motorRightTwo.configNominalOutputForward(0, 0);
	RobotMap.motorLeftThree.configPeakOutputReverse(-0.9, 0);
	RobotMap.motorLeftThree.configNominalOutputReverse(0, 0);
   ...
   // RobotMap.motorLeftThree.config_kP(0, 0.00045, 0);
 ...
 //     RobotMap.motorRightTwo.config_kI(0, 0.000000009, 0);
  ...
  //	RobotMap.motorRightTwo.configAllowableClosedloopError(0, 300, 0);
	...
	RobotMap.motorLeftThree.configMotionAcceleration((AccelerationLeft*4096)/600, 0);
   ...
   /* System.out.println(Timer.getFPGATimestamp()-starttime + " time ");
    ...
    protected void end() {
    RobotMap.motorLeftThree.enableVoltageCompensation(false);
    RobotMap.motorRightThree.enableVoltageCompensation(false);
